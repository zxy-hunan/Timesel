package com.hunan_zxy.timelib.widget;

/**
 * FileName: WheelView
 * Author: jibinghao
 * Date: 2019/5/13 9:45 AM
...
import com.hunan_zxy.timelib.listener.OnWheelClickedListener;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.wv_val);
        }
